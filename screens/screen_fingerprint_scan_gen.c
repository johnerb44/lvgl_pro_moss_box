...
#include "screen_fingerprint_scan_gen.h"
...
lv_obj_t * screen_fingerprint_scan_create(void)
{
    ...
    lv_obj_set_name_static(lv_obj_0, "screen_fingerprint_scan_#");
    lv_obj_set_style_text_color(lv_obj_0, lv_color_hex3(0xfff), 0);

    lv_obj_add_style(lv_obj_0, &style_main, 0);
    lv_obj_t * fingerprint_title = lv_label_create(lv_obj_0);
    lv_obj_set_name(fingerprint_title, "fingerprint_title");
    lv_label_set_text(fingerprint_title, "Fingerprint Scan");
    lv_obj_set_style_text_font(fingerprint_title, montserrat_30, 0);
    lv_obj_set_align(fingerprint_title, LV_ALIGN_TOP_MID);
    lv_obj_set_y(fingerprint_title, 10);
